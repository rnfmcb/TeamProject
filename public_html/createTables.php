<?php
    ...
    $student = "CREATE TABLE ". $database .".`student` ( `SSOID` VARCHAR(10) NOT NULL ,  `LASTNAME` VARCHAR(45) NOT NULL ,  `FIRSTNAME` VARCHAR(45) NOT NULL ,  `EMAIL` VARCHAR(45) NOT NULL ,    PRIMARY KEY  (`SSOID`),    UNIQUE  (`EMAIL`)) ENGINE = InnoDB;";
    ...
    $experience = "CREATE TABLE ". $database .".`experience` ( `EXPID` INT UNSIGNED NOT NULL AUTO_INCREMENT , `CATEGORY` VARCHAR(45) NOT NULL , `DATE` DATE NOT NULL , `HOURS` INT UNSIGNED NOT NULL , `DESCRIPTION` VARCHAR(1000) NOT NULL , `ORGANIZATION` VARCHAR(45) NOT NULL , `VERIFIED` VARCHAR(10) NOT NULL , PRIMARY KEY (`EXPID`), FOREIGN KEY (`VERIFIED`) REFERENCES `teacher`(`SSOID`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE = InnoDB;";
